...
export default function Footer() {
  return (
    <footer className="w-full flex flex-col justify-center items-start max-w-2xl mx-auto mt-32">
      ...
      <div className="w-full max-w-2xl grid grid-cols-1 gap-4 pb-16 justify-items-center sm:grid-cols-2">
      ...
      <p className="flex justify-center mx-auto w-full text-gray-500 hover:text-gray-600 transition">
