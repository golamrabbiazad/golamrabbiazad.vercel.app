...
From then I was building my portfolio website project. When I'm at half of my project I exactly remember <b>Nov 23, 2021, </b> stole my MacBook pro early 2015 which my father brought for my undergraduate program.
...
I did a contract-based job <b>(1 month)</b>. My role was Data Annotator which I have to complete 5 buckets (buckets containing 10 to 20 images, JSON files) per day I have to check and fix the error and create JSON files & sync with images.
